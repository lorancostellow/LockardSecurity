...
from picom.Data.PayloadObj import\
    ...
    send_payload,\
    receive_payload
from picom.helpers import encode_to_json, decode_from_json
...
class Client:
    ...
    def to_json(self):
        return encode_to_json({"host": self.host,
                               "port": self.port,
                               "ignore_error": self.ignore_errors})

    @staticmethod
    def from_json(json: str):
        args = decode_from_json(json)
